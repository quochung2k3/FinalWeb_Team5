                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <form action="admin-voucher-add" class="mx-1 mx-md-4" method="post">
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div style="border: 1px solid #ccc; border-radius: 10px" class="form-outline flex-fill mb-0">
                                            <input name="tenVoucher" type="text" class="form-control" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div style="border: 1px solid #ccc; border-radius: 10px" class="form-outline flex-fill mb-0">
                                            <input name="phanTramGiam" type="number" id="form3Example5c" class="form-control" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        <i style="font-size: 20px" class="fa-solid fa-user-tie me-3 fa-fw"></i>
                                        <div style="border: 1px solid #ccc; border-radius: 10px" class="form-outline flex-fill mb-0">
                                            <input name="ngayBatDau" type="date" id="" class="form-control" required>
                                        </div>
                                    </div>
