        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <a href="<c:url value="/admin-customer-add"/>" class="btn btn-primary"><span>Add Voucher</span></a>
                ...
                <c:forEach var = "item" items = "${listVoucher}">
                    <tr>
                        ...
                        <td style="
                                            ...
                                            align-items: center;
                                        ">
                            <a href="admin-customer-update?maVC=${item.maVC}" class="settings" title="Settings" data-toggle="tooltip"><i class="material-icons">&#xE8B8;</i></a>
                            <a href="admin-customer-history?maVC=${item.maVC}" class="settings" title="Purchase History" data-toggle="tooltip"><i class="material-icons">&#xE86A;</i></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
