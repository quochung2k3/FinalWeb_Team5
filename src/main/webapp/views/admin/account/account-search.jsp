    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <div class="clearfix" id="partialReloadDiv">
                ...
                <ul class="pagination">
                    <li class="page-item"><a class="page-link" href="admin-account-search?index=1" ${index==1 ? "style=\"color: red;\"" : ""}>1</a></li>
                    <c:forEach begin = "2" end = "${numpage}" var = "i">
                        <li class="page-item"><a class="page-link" href="admin-account-search?index=${i}" ${index==i ? "style=\"color: red;\"" : ""}>${i}</a></li>
                    </c:forEach>
                </ul>
            </div>
        </div>
